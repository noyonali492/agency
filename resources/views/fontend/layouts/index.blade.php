...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Favicon -->
        <link rel="icon" href="{{asset('fontend/img/favicon.png')}}">
    ...
    <body>
		...
		<!-- Color JS -->
		<script src="{{asset('fontend/js/colors.js')}}"></script>
		<!-- Popper JS -->
		...
		<!-- Niceselect JS -->
		<script src="{{asset('fontend/js/niceselect.js')}}"></script>
		<!-- Tilt Jquery JS -->
		...
		<!-- Steller JS -->
		<script src="{{asset('fontend/js/steller.js')}}"></script>
		<!-- Wow JS -->
